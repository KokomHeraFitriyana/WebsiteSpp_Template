							...
							<div class="col-lg-6">
								...
								<form class="user" method="post" action="">
									<div class="form-group">
										...
										<input type="text" autocomplete="off" required name="nama_admin" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name..." value="<?= $res['nama_admin'] ?>">	
									</div>
									<div class="form-group">
										<input type="text" autocomplete="off" required name="user_admin" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Username..." value="<?= $res['user_admin'] ?>">	
									</div>
									<div class="form-group">
